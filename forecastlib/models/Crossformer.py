...
from forecastlib.layers.Crossformer_EncDec import Decoder, DecoderLayer, Encoder, scale_block
from forecastlib.layers.Embed import PatchEmbedding
from forecastlib.layers.SelfAttention_Family import AttentionLayer, FullAttention, TwoStageAttentionLayer
from forecastlib.models.PatchTST import FlattenHead
        ...
        self.encoder = Encoder(
            [
                scale_block(
                    ...
                    1,
                    configs.dropout,
                    self.in_seg_num if layer == 0 else ceil(self.in_seg_num / self.win_size**layer),
                    configs.factor,
                )
