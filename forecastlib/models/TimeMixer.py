...
from forecastlib.layers.Autoformer_EncDec import series_decomp, series_decomp_diff, series_decomp_diff_roll
from forecastlib.layers.Embed import DataEmbedding_wo_pos
from forecastlib.layers.StandardNorm import Normalize
    ...
    def __init__(self, configs):
        ...
        if configs.decomp_method == "moving_avg":
            ...
            if configs.decomp_type == "series_decomp":
                ...
                self.decompsition = series_decomp_diff()
            elif configs.decomp_type == "series_decomp_diff_roll":
                self.decompsition = series_decomp_diff_roll(configs.moving_avg)
            else:
                self.decompsition = series_decomp(configs.moving_avg)
