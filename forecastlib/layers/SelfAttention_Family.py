...
from forecastlib.utils.masking import ProbMask, TriangularCausalMask
...
class ReformerLayer(nn.Module):
    def __init__(
        self, attention, d_model, n_heads, d_keys=None, d_values=None, causal=False, bucket_size=4, n_hashes=4
    ):
        super().__init__()
